...
Più interessante è invece il fenomeno dello \textit{swarm robotics} o ``robotica degli sciami''. Questo campo di ricerca fonde la robotica con l'intelligenza artificiale 
e studia i comportamenti degli insetti sociali in modo tale da poterli riprodurre. Ogni robot è programmato per manifestare lo stesso comportamento 
che un insetto manifesterebbe in natura, sia come individuo che come collettivo. Questi studi sono estremamente interessanti e dimostrano come
l'intelligenza manifestata dal collettivo superi di gran lunga quella del singolo individuo, al punto che si parla di intelligenza collettiva o ``swarm intelligence''.
