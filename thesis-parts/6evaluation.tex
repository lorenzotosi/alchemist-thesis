...
\section{Aggregazione con diffusione minima}\label{sim2}
...
\section{Aggregazione con un minor numero di nodi}\label{sim3}
...
\section{Aggregazione in uno spazio più piccolo}\label{sim5}
