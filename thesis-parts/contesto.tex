...
progettato per eseguire simulazioni di modelli complessi e dinamici.
...
in tantissime ``micro-aree'' chiamate \textit{patch}\space\cref{fig:patch}. La tartaruga per muoversi 
